...
const NewBottomSheet = React.forwardRef<NewBottomSheetRefProps, NewBottomSheetProps>(
  ({ children, logo }, ref) => {
    ...
    return (
      <GestureDetector gesture={gesture}>
        <Animated.View style={[modalStyle.bottomSheetContainer, rNewBottomSheetStyle]}>
